...
- **Debian Packaging** add Debian packaging and build action in /workflows. This should allow any change to main create a new release, for the user to download the `.hardn-xdr_1.1.48` from releases.
