...
# This shell script, alt_sys_setup.sh, is a refactored version of the original, minus the python venv part.
# Scalable, reformatted for readability, and all function calls have been moved into the main function.
