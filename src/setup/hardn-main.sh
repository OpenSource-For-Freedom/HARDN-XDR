...
EOF
    ...
    if [[ -f "$grub_config" ]]; then
        ...
        # Add or update GRUB_CMDLINE_LINUX to prevent single user mode without password
        ...
        # Disable recovery mode access without password
    ...
    # Save GRUB password securely for admin reference
