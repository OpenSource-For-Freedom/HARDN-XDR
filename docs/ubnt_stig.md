# HARDN-Ubuntu STIG Compliance Overview

This document summarizes the DISA STIG (Security Technical Implementation Guide) controls and hardening measures implemented by the HARDN project for Ubuntu 24.04-based systems.
...
- **Firewall (UFW):**  
  ...
  - Only essential outbound ports allowed (HTTP, HTTPS, DNS, NTP, Ubuntu mirrors)
